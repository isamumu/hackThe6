...
class Header extends React.Component {
    //if user click login, show register form on webpage
    handleLogin = () => {
        this.props.showLoginForm(true);
        this.props.showRegisterForm(false);
    };

    //if user click register, show register form on webpage
    handleRegister = () => {
        this.props.showRegisterForm(true);
        this.props.showLoginForm(false);
    };

    //if user logged out, remove corresponding userID and TOKEN in local storage
    handleLogOut = () => {
    ...
    showMenu = () => {
        ...
        //if user logged in, the local storage has the user ID
        if (localStorage.getItem(ID)) {
            ...
            // if user did not logged in, then user can register account ot login in with account
            return <div>
    ...
    // user profile icon is bootstrap, the fillRule is from: https://icons.getbootstrap.com/icons/person-circle/
    render() {
        return (
